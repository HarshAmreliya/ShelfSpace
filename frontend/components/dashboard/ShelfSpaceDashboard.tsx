...
const ShelfSpaceDashboard = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "ai",
      content:
        "Hello! I'm your personal reading assistant. I can help you discover new books, track your reading goals, discuss literature, and answer questions about your library. What would you like to explore today?",
      timestamp: new Date(Date.now() - 300000),
      suggestions: [
        "Recommend me a book",
        "Analyze my reading habits",
        "Help me set a reading goal",
  ...
  const recommendations = [
    ...
    },
    {
      ...
      reason: "Mystery lovers also enjoyed",
      cover: "🔍",
    },
    {
      id: 3,
