...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-dye-50 to-indigo-dye-100 dark:from-gray-800 dark:to-gray-950 p-4">
